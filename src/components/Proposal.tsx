...
const LOGFRAME: { k: string; t: string; d: string }[] = [
  ...
  { k: "Outcomes", t: "영향", d: "학장천 한 병목에서 우기 부유 쓰레기 흐름이 활동 전후로 달라지는지를 측정 가능한 숫자로 보인다. 차단율은 보수적으로 약 팔 퍼센트로 본다. 시민의 책임감 변화를 함께 기록한다." },
  { k: "Outputs", t: "산출", d: "OpenBoom 한 기의 실증, 우기 알림과 데이터 인프라, 활동 전후 부유 쓰레기 흐름 곡선, 누구나 복제하는 공개 도면과 데이터." },
  { k: "Activities", t: "활동", d: "구청 사전 협의와 점용 허가, 우기 전 설치, 주 일 회 시민 수거와 품목 분류, 영상과 수위 기록, 우기 후 철거와 원상 복구." },
  ...
  return (
    <main className="min-h-screen bg-white text-neutral-900">
      ...
      <div className="mx-auto max-w-3xl px-5">
        ...
        <Section id="dashboard" eyebrow="근거 · 실행 증거" title="이미 작동하는 우기 모니터링">
          <p>우리는 계획만 제출하지 않습니다. 아래는 공개 데이터로 작동하는 우기 모니터링입니다. 강수와 호우 특보와 하천 수위를 한 화면에서 보고 촬영 시점과 비상 철거 시점을 판단합니다. 작은 하천의 실시간 수위는 공개 자료가 없으므로 자체 계측으로 메웁니다.</p>
