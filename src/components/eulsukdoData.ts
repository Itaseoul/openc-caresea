...
export const SITES: Site[] = [
  ...
  },
  {
    ...
    color: "#475569",
    name: "낙동강하굿둑(동측 구수문)",
    desc: "을숙도 북부 횡단(하단–을숙도–명지) · 둑 북=담수호, 남=바다 · K-water 관리",
    approx: true,
  },
  {
    id: "3",
  ...
  },
  {
    ...
    lng: 128.862,
    color: "#7c3aed",
    name: "하구 사주 무인도서(진우도 등)",
    desc: "실측 집적지 — 해양환경공단 약 2개월 501톤 수거 · 구성 약 86% 대형 목재류",
    approx: true,
  },
];
...
export const CANDIDATES: Site[] = [
  {
    ...
    desc: "바다로 빠지기 직전 '마지막 길목'(발생원 차단 논리 최상위) · 규모·시의성 최상이나 난이도 높고 수문 앞 집적 관측자료 없음 → K-water 수거일지로 타당성 선검증",
    approx: true,
  },
  {
    id: "B",
    ...
    desc: "폭 좁은 제방형 수로의 단일 배출구 → 물리적으로 가장 현실적 · 단 전체 부유물 비중은 미상",
    approx: true,
  },
  {
    id: "C",
    ...
    desc: "사하구 유일 지방하천의 개방 하구(복원 개거 폭 ~46m) · 상류 대부분 복개라 표층 유입 제한적일 수 있음",
    approx: true,
  },
];
...
export const STREAMS_SAHA: StreamRow[] = [
  ...
  { name: "괴정천", grade: "지방하천", width: "복원개거 >10m / 복개 미상", outlet: "낙동강 본류 하구(하단)", conf: "상" },
