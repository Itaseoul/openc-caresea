...
export const metadata = {
  ...
  description:
    "실증 스팟과 용도(부유식 붐 / 환경감시 CCTV)를 고르면 하천 등급·관할·보호구역에 따라 필요한 허가·협의 순서·요건 체크리스트와 사전채움 문서팩(사업계획서·행정예고·MOU·정보공개청구·사전협의 공문)을 생성합니다.",
};
    ...
    <main style={{ minHeight: "100vh", background: "#eef2f6", color: "#0f172a" }}>
      <div style={{ maxWidth: 880, margin: "0 auto", padding: "20px 16px 40px" }}>
        ...
        <p style={{ fontSize: 13.5, color: "#475569", lineHeight: 1.65, marginTop: 8, maxWidth: 720 }}>
          용도(<b>부유식 붐</b> 또는 <b>환경감시 CCTV</b>)와 실증 후보 하천을 선택하면 그 스팟의 <b>법정 등급·점용허가 처분청·보호구역 여부</b>에 따라
          필요한 허가와 협의 순서, 요건 체크리스트, 그리고 <b>사전채움 문서팩</b>을 생성합니다.
          등급에 따라 근거 조문이 갈립니다. 지방·국가하천은 하천법 제33조, 소하천은 소하천정비법 제14조, 기타하천은 ‘확인 필요’로 표시합니다.
          CCTV 용도는 개인정보 보호법 제25조 행정예고·운영방침·안내판과 민관 데이터 협약(MOU)·기부채납 문서를 함께 생성합니다.
        </p>
        ...
        <div style={{ marginTop: 18, fontSize: 11, color: "#94a3b8", lineHeight: 1.75 }}>
          근거: 하천법 제33조 · 「하천점용허가 세부기준」(환경부) · 하천법 시행령 제44조 · 소하천정비법 제14조 · 개인정보 보호법 제25조 · 자연유산법 제17조 · 부산시 사무위임 조례.
          상세 검토는 docs/하천점용허가-적합성검토.md, 정보공개청구서-초안.md, 소하천-CCTV-민관데이터협력-모델.md 참조. 본 페이지는 공개자료 기반 실무 보조 도구이며 인허가·법률 자문이 아닙니다.
        </div>
